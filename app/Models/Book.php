...
class Book extends Model
{
    ...
    // We create another scope to get the reviews count without applying sorting (unlike in scopePopular)
    ...
    {
        static::updated(callback: fn(Book $book) => cache()->forget('book:' . $book->id));
